 ...
 *
 */
public class PanoramioEventItem implements Parcelable {
    ...
    public PanoramioEventItem(Parcel in) {
        mId = in.readLong();
    ...
    public PanoramioEventItem(long id, String title) {
        mId = id ;
    	//mBitmap = b;
...
//    }
//
    public static final Parcelable.Creator<PanoramioEventItem> CREATOR =
        new Parcelable.Creator<PanoramioEventItem>() {
        public PanoramioEventItem createFromParcel(Parcel in) {
            return new PanoramioEventItem(in);
        }

        public PanoramioEventItem[] newArray(int size) {
            return new PanoramioEventItem[size];
        }
    };
