...
public class EventAdapter extends BaseAdapter {
    ...
    /**
     * Used by the {@link EventManager} to report changes in the list back to
     * this adapter.
     */
    ...
    public EventAdapter(Context c) {
        mEventManager = EventManager.getInstance(c);
        mContext = c;
    ...
    public Object getItem(int position) {
        return mEventManager.get(position);
    }
    ...
    public long getItemId(int position) {
        PanoramioEventItem s = mEventManager.get(position);
        return s.getId();
    }
