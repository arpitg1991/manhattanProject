...
public class EventList extends ListActivity {
    ...
    /**
     * Observer used to turn the progress indicator off when the {@link EventManager} is
     * done downloading.
     */
    private class MyDataSetObserver extends DataSetObserver {
        @Override
        public void onChanged() {
            if (!mEventManager.isLoading()) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mEventManager.isLoading()) {
            ...
            mEventManager.addObserver(mObserver);
        }
        
        // Read the user's search area from the intent
        Intent i = getIntent();
        mZoom = i.getIntExtra(EventManager.ZOOM_EXTRA, Integer.MIN_VALUE);
        mLatitudeE6 = i.getIntExtra(EventManager.LATITUDE_E6_EXTRA, Integer.MIN_VALUE);
        mLongitudeE6 = i.getIntExtra(EventManager.LONGITUDE_E6_EXTRA, Integer.MIN_VALUE);
    }
//
//    @Override
//    protected void onListItemClick(ListView l, View v, int position, long id) {
//        PanoramioEventItem item = mEventManager.get(position);   
//        
...
//        i.putExtra(EventManager.PANORAMIO_ITEM_EXTRA, item);
//        i.putExtra(EventManager.ZOOM_EXTRA, mZoom);
//        i.putExtra(EventManager.LATITUDE_E6_EXTRA, mLatitudeE6);
//        i.putExtra(EventManager.LONGITUDE_E6_EXTRA, mLongitudeE6);
//        startActivity(i);
//    }   
